...
import com.staybooking.service.SearchService;
...
public class SearchController {
    ...
    // search controller with parameters:
    // guestNumber: how many guests for the stay
    // start: check in date in local time
    // end: check out date in local time
    // lat: latitude of the stay address
    // lon: longitude of the stay address
    // distance: the search distance from the selected address
